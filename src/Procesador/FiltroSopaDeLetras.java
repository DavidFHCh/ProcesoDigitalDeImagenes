...
public class FiltroSopaDeLetras{
	...
	public FiltroSopaDeLetras(PixelReader pr1,int width1, int height1, int regionAlto,int regionAncho){
		pr = pr1;
		width = width1;
		height = height1;
    ...
    public String aplicaFiltro(boolean gris){
		...
		for(int i = 0; i < height; i++){
			...
			for(int j = 0; j < width;j++){
				...
				String s = "<b style='font-family:consolas; color:rgb("+ (int)rprom + "," + (int)gprom + "," + (int)bprom +");;'>@</b>\n";
